 ...
 * *Restful_authentication* With email activation, and forgot_password features built in
 * The ability to use Gmail as your smtp server for sending emails
 * Will_paginate
 ...
 * TinyMCE HTML Editor, always handy to have that around